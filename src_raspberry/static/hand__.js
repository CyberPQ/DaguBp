(function() {
    ...
    var e = ["PointerDown", "PointerUp", "PointerMove", "PointerOver", "PointerOut", "PointerCancel", "PointerEnter", "PointerLeave", "pointerdown", "pointerup", "pointermove", "pointerover", "pointerout", "pointercancel", "pointerenter", "pointerleave"];
    var t = "touch";
    var n = "pen";
    var r = "mouse";
    var i = {};
    ...
    var o = function(e, i) {
        ...
        if (e.isPrimary !== undefined) o.isPrimary = e.isPrimary;
        else o.isPrimary = true;
        if (e.pressure) o.pressure = e.pressure;
        else {
            var u = 0;
            if (e.which !== undefined) u = e.which;
        ...
        if (e.hwTimestamp) o.hwTimestamp = e.hwTimestamp;
        else o.hwTimestamp = 0;
        if (e.tiltX) o.tiltX = e.tiltX;
        else o.tiltX = 0;
        if (e.tiltY) o.tiltY = e.tiltY;
        else o.tiltY = 0;
        if (e.height) o.height = e.height;
        else o.height = 0;
        if (e.width) o.width = e.width;
        else o.width = 0;
    ...
    var p = function(t, n, r) {
        var i;
        if (r == r.toLowerCase()) {
            var s = e.indexOf(r) - e.length / 2;
            i = n + e[s]
        } else {
            i = n + r
        }
        if (i === n + "PointerEnter" && t["on" + n.toLowerCase() + "pointerenter"] === undefined) {
            i = n + "PointerOver"
        }
        if (i === n + "PointerLeave" && t["on" + n.toLowerCase() + "pointerleave"] === undefined) {
            i = n + "PointerOut"
        }
        return i
    };
